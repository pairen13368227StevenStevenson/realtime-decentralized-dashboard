...
![My Mint](../../helpArticles/assets/images/pngs/lockingInDam/lockin1L2.png)

By pressing Enable, Datamine checks your FLUX (L2) and ETH balances before allowing you to start your mint. Every transaction or smart contract in Ethereum requires gas. Starting a mint is done via a smart contract. If you do not have Ethereum on L2 to pay a small gas fee, you will be unable to start your mint. Therefore, we recommend that you have a starting balance of ~$20 in Ethereum on Arbitrum L2. 
...
You can now begin by clicking the "Start Mint" button. After paying a small gas fee for starting your mint, you will instantly start generating ArbiFLUX tokens in your dashboard (**with every single block ~ 15 seconds, you generate of 0.00000001 ArbiFLUX per 1 FLUX (L2) in mint**)

![Start Mint](../../helpArticles/assets/images/pngs/lockingInDam/lockin3L2.png)

## Step 2

To continue, enter how many FLUX (L2) tokens you wish to use for your mint. You can stop your mint to get 100% of FLUX (L2) tokens back at any time.
...
Congratulations, your mint is now started! You are now generating ArbiFLUX tokens. You can stop your mint at any time to get 100% of your FLUX (L2) tokens back.

**Stopping a mint will cause you to lose your current time bonus. Any unminted ArbiFLUX tokens will also be lost. We recommend that you mint your ArbiFLUX tokens before stopping a mint.**